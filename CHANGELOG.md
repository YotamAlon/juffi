...
### Fixed
- Fixed a few display glitches related to "smart" redrawing


## [0.4.2] - 2026-01-27

### Fixed
- Fixed details mode display glitch

## [0.4.1] - 2026-01-18

### Fixed
- Improved error handling for screen drawing operations to make errors more helpful
...
[0.5.0]: https://github.com/YotamAlon/juffi/releases/tag/v0.5.0
[0.4.2]: https://github.com/YotamAlon/juffi/releases/tag/v0.4.2
[0.4.1]: https://github.com/YotamAlon/juffi/releases/tag/v0.4.1
